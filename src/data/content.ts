...
export const clubContent = {
  ...
  articlesKicker: "start here",
  articlesTitle: "Начните отсюда",
  welcomeTitle: "Добро пожаловать в клуб",
  welcomeText:
    "Мы рады, что вы присоединились к Vedara Longevita. Здесь вы начнете с базовых материалов, поймете логику трекера и постепенно перейдете к практикам, которые помогают выстроить ритм, энергию и состояние.",
  methodTitle: "Что такое Longevita метод",
  methodText:
    "Longevita метод — мягкая система ежедневных действий: привычки, состояние, практики, питание, восстановление и поддержка сообщества. Вы двигаетесь по шагам, отмечаете состояние в трекере и видите, как образ жизни влияет на самочувствие.",
  communityKicker: "community",
  communityTitle: "Клубное общение",
  communityText: "Обсуждайте практики, задавайте вопросы куратору и следите за эфирами клуба.",
  chatCta: "Перейти в чат",
  open: "Открыть",
...
export const clubVideos: ClubVideo[] = [
  {
    id: "start-here",
    title: "Начни отсюда",
    description: "Первый маршрут по материалам, трекеру и спокойному входу в клубный ритм.",
    category: "старт",
    duration: "8 мин",
    icon: "material",
    access: "club",
  ...
  },
  {
    id: "club-lectures",
    title: "Лекции клуба",
    description: "Короткие объяснения метода, привычек и восстановления без перегруза.",
    category: "лекции",
    duration: "15 мин",
    icon: "material",
    access: "club",
  ...
  },
  {
    id: "schedule",
    title: "Расписание",
    description: "Порядок материалов, эфиров и мягких недельных акцентов клуба.",
    category: "план",
    duration: "3 мин",
    icon: "protocol",
    access: "club",
...
export const clubArticles: ClubArticle[] = [
  {
    ...
    description: "Что подготовить для старта в клубе и комфортного прохождения практик.",
    readingTime: "5 мин",
    icon: "protocol",
    access: "club",
    completed: false,
  },
  {
    ...
    description: "Как отмечать привычки, состояние и смотреть динамику недели и месяца.",
    readingTime: "6 мин",
    icon: "material",
    access: "club",
    completed: false,
  },
  {
    ...
    description: "Базовые идеи питания и рецепты для мягкой поддержки организма.",
    readingTime: "7 мин",
    icon: "nutrition",
    access: "club",
    completed: false,
